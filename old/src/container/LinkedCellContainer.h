...
class LinkedCellContainer : public ParticleContainerInterface {
 private:
  ...
  /**
     ...
     * @param particle
     */
  [[nodiscard]] std::array<int, 3> getCellCoordinates(
  ...
  /**
     ...
     */
  [[nodiscard]] int getIndexFromCoordinates(
      std::array<int, 3> cellCoordinates) const;
  ...
  */
  enum BoundaryConditions { outflow, reflection, periodic };
  ...
  */
  ...
  /**
     ...
     */
  [[nodiscard]] std::vector<Particle> retrieveNeighbors(
      const Particle& particle) const;
  ...
  /**
    ...
    */
  [[nodiscard]] std::vector<int> retrieveBoundaryCellIndices(
      ContainerSide side) const;
  ...
  /**
     ...
     * The side of which the indices of the halo cells are to be retrieved
     */
  [[nodiscard]] std::vector<int> retrieveHaloCellIndices(
      ContainerSide side) const;
