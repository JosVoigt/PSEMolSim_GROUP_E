    ...
    case 2UL:
    {
      if (n == "distance" && ns.empty ())
      {
        ...
        else
        {
          if (this->distance_parser_)
          {
            this->distance (this->distance_parser_->post_double ());
          }
    ...
    case 7UL:
    {
      if (n == "brownianMotionMean" && ns.empty ())
      {
        ...
        else
        {
          if (this->brownianMotionMean_parser_)
          {
            this->brownianMotionMean (this->brownianMotionMean_parser_->post_double ());
          }
    ...
    case 0UL:
    {
      if (n == "delta" && ns.empty ())
      {
        ...
        else
        {
          if (this->delta_parser_)
          {
            this->delta (this->delta_parser_->post_double ());
          }
    ...
    case 2UL:
    {
      if (n == "start" && ns.empty ())
      {
        ...
        else
        {
          if (this->start_parser_)
          {
            this->start (this->start_parser_->post_double ());
          }
    ...
    case 3UL:
    {
      if (n == "end" && ns.empty ())
      {
        ...
        else
        {
          if (this->end_parser_)
          {
            this->end (this->end_parser_->post_double ());
          }
    ...
    case 4UL:
    {
      if (n == "outfile" && ns.empty ())
      {
        ...
        else
        {
          if (this->outfile_parser_)
          {
            this->outfile (this->outfile_parser_->post_string ());
          }
