...
void XYZWriter::plotParticles(std::shared_ptr<ParticleContainerInterface> &particles,
    ...
    file << "Generated by MolSim. See http://openbabel.org/wiki/XYZ_(format) "
            "for "
            "file format doku."
         << std::endl;

    auto allParticles = particles->preprocessParticles();
