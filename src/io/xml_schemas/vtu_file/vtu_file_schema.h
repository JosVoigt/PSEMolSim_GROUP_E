...
/**
 * @file
 * @brief Generated from vtu_file_schema.xsd.
 */

#ifndef VTU_FILE_SCHEMA_H
#define VTU_FILE_SCHEMA_H
...
class PieceUnstructuredGrid_t : public ::xml_schema::type {
   public:
     ...
     * initializers for required elements and attributes.
     */
    PieceUnstructuredGrid_t(const PointData_type&, const CellData_type&, const Points_type&, const Cells_type&, const NumberOfPoints_type&,
 ...
 * names
 * to which this greeting applies.
 *
 * @nosubgrouping
 */
 ...
 * conforming
 * document should start with this element.
 */
//@{
